...
public class TreeProblems {
    ...
    public static Set<Integer> different(Set<Integer> setA, Set<Integer> setB) {
        ...
        // add all elements in set B to set A
        result.addAll(setB);
        // temporary set for the intersection of A and B
        Set<Integer> commonElements = new TreeSet<>(setA);
        commonElements.retainAll(setB);
        // remove common elements and return the result.
    ...
    public static void removeEven(Map<Integer, String> treeMap) {
        ...
        while (iterator.hasNext()) {
            ...
            // check if key is even, if so, remove.
            if (key % 2 == 0) {
                iterator.remove();
            }
        }
